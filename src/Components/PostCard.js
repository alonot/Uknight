...
const PostCard = () => {
    const profilephototxt = "PP"
    const profileusernametxt = "Priyanshu Pandey"
    const message = "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration  If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything. There are many variations of passages of Lorem Ipsum availabl. There are many variations of passages of Lorem Ipsum availabl....."
    return (
        <div className="postcontainer">
            <div className="profilephoto"><h3>{profilephototxt}</h3></div>
            <div className="rest">
                <div className="info">
                    <div className="profileusername" ><a href="/">{profileusernametxt}</a></div>
                </div>
